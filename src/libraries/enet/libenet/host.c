...
/** Creates a host for communicating to peers.
    ...
    @param address   the address at which other peers may connect to this host.  If NULL, then no
   peers may connect to the host.
   ...
   assume unlimited bandwidth.
    @param outgoingBandwidth upstream bandwidth of the host in bytes/second; if 0, ENet will assume
   unlimited bandwidth.
    ...
    the window size of a connection which limits the amount of reliable packets that may be in
...
void enet_host_bandwidth_throttle(ENetHost *host)
{
  enet_uint32 timeCurrent = enet_time_get(),
              ...
              peersRemaining = (enet_uint32) host->connectedPeers, dataTotal = ~0, bandwidth = ~0,
