...
static int vdfLoadEntries(PHYSFS_Io *io, const PHYSFS_uint32 count, const PHYSFS_sint64 ts,
                          void *arc)
{
  PHYSFS_uint32 i;
...
static void *VDF_openArchive(PHYSFS_Io *io, const char *name, int forWriting, int *claimed)
{
...
const PHYSFS_Archiver __PHYSFS_Archiver_VDF = {
    ...
    {
        "VDF", "Gothic I/II engine format",
        "Francesco Bertolaccini <bertolaccinifrancesco@gmail.com>", "https://github.com/frabert",
        0, /* supportsSymlinks */
    },
    VDF_openArchive,
    UNPK_enumerate,
