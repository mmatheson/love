...
static void *SLB_openArchive(PHYSFS_Io *io, const char *name, int forWriting, int *claimed)
{
...
const PHYSFS_Archiver __PHYSFS_Archiver_SLB = {
    ...
    {
        "SLB", "I-War / Independence War Slab file", "Aleksi Nurmi <aleksi.nurmi@gmail.com>",
