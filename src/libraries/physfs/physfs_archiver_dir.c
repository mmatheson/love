...
static char *cvtToDependent(const char *prepend, const char *path, char *buf, const size_t buflen)
{
...
static void *DIR_openArchive(PHYSFS_Io *io, const char *name, int forWriting, int *claimed)
{
  PHYSFS_Stat st;
...
static PHYSFS_EnumerateCallbackResult DIR_enumerate(void *opaque, const char *dname,
...
static void DIR_closeArchive(void *opaque) { allocator.Free(opaque); } /* DIR_closeArchive */
...
const PHYSFS_Archiver __PHYSFS_Archiver_DIR = {
    ...
    {
        "", "Non-archive, direct filesystem I/O", "Ryan C. Gordon <icculus@icculus.org>",
