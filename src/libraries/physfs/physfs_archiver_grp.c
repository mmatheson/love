...
static void *GRP_openArchive(PHYSFS_Io *io, const char *name, int forWriting, int *claimed)
{
  PHYSFS_uint8 buf[12];
...
const PHYSFS_Archiver __PHYSFS_Archiver_GRP = {
    ...
    {
        "GRP", "Build engine Groupfile format", "Ryan C. Gordon <icculus@icculus.org>",
