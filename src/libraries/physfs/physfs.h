...
#define PHYSFS_VERSION(x)          \
   ...
   * \sa PHYSFS_getSearchPath
   */
  PHYSFS_DECL int PHYSFS_addToSearchPath(const char *newDir, int appendToPath) PHYSFS_DEPRECATED;
   ...
   * \sa PHYSFS_unmount
   */
  PHYSFS_DECL int PHYSFS_removeFromSearchPath(const char *oldDir) PHYSFS_DEPRECATED;
  ...
  /**
   * \fn int PHYSFS_setSaneConfig(const char *organization, const char *appName, const char
   * *archiveExt, int includeCdRoms, int archivesFirst) \brief Set up sane, default paths.
   *
   * Helper function.
   *
   ...
   */
  PHYSFS_DECL int PHYSFS_setSaneConfig(const char *organization, const char *appName,
   ...
   * \sa PHYSFS_stat
   */
  PHYSFS_DECL PHYSFS_sint64 PHYSFS_getLastModTime(const char *filename) PHYSFS_DEPRECATED;
  ...
  /**
   * \fn PHYSFS_sint64 PHYSFS_read(PHYSFS_File *handle, void *buffer, PHYSFS_uint32 objSize,
   * PHYSFS_uint32 objCount) \brief Read data from a PhysicsFS filehandle
   *
   ...
   * \sa PHYSFS_eof
   */
  PHYSFS_DECL PHYSFS_sint64 PHYSFS_read(PHYSFS_File *handle, void *buffer, PHYSFS_uint32 objSize,
                                        PHYSFS_uint32 objCount) PHYSFS_DEPRECATED;

  /**
   * \fn PHYSFS_sint64 PHYSFS_write(PHYSFS_File *handle, const void *buffer, PHYSFS_uint32 objSize,
   * PHYSFS_uint32 objCount) \brief Write data to a PhysicsFS filehandle
   *
   ...
   */
  PHYSFS_DECL PHYSFS_sint64 PHYSFS_write(PHYSFS_File *handle, const void *buffer,
   ...
   * \sa PHYSFS_mountIo
   */
  PHYSFS_DECL int PHYSFS_mount(const char *newDir, const char *mountPoint, int appendToPath);
   ...
   */
  PHYSFS_DECL void PHYSFS_enumerateFilesCallback(const char *dir, PHYSFS_EnumFilesCallback c,
   ...
   */
  PHYSFS_DECL void PHYSFS_utf8FromUcs4(const PHYSFS_uint32 *src, char *dst, PHYSFS_uint64 len);
   ...
   *   \param len Size, in bytes, of destination buffer.
   */
  PHYSFS_DECL void PHYSFS_utf8ToUcs4(const char *src, PHYSFS_uint32 *dst, PHYSFS_uint64 len);
   ...
   */
  PHYSFS_DECL void PHYSFS_utf8FromUcs2(const PHYSFS_uint16 *src, char *dst, PHYSFS_uint64 len);
   ...
   */
  PHYSFS_DECL void PHYSFS_utf8ToUcs2(const char *src, PHYSFS_uint16 *dst, PHYSFS_uint64 len);
   ...
   *   \param len Size, in bytes, of destination buffer.
   */
  PHYSFS_DECL void PHYSFS_utf8FromLatin1(const char *src, char *dst, PHYSFS_uint64 len);
   ...
   *  \return -1 if str1 is "less than" str2, 1 if "greater than", 0 if equal.
   */
  PHYSFS_DECL int PHYSFS_utf16stricmp(const PHYSFS_uint16 *str1, const PHYSFS_uint16 *str2);
   ...
   *  \return -1 if str1 is "less than" str2, 1 if "greater than", 0 if equal.
   */
  PHYSFS_DECL int PHYSFS_ucs4stricmp(const PHYSFS_uint32 *str1, const PHYSFS_uint32 *str2);
   ...
   * \code
   *
   * static PHYSFS_EnumerateCallbackResult printDir(void *data, const char *origdir, const char
   * *fname)
   * {
   ...
   * \sa PHYSFS_enumerateFiles
   */
  PHYSFS_DECL int PHYSFS_enumerate(const char *dir, PHYSFS_EnumerateCallback c, void *d);
   ...
   *   \param len Size, in bytes, of destination buffer.
   */
  PHYSFS_DECL void PHYSFS_utf8FromUtf16(const PHYSFS_uint16 *src, char *dst, PHYSFS_uint64 len);
   ...
   * \sa PHYSFS_utf8ToUtf16
   */
  PHYSFS_DECL void PHYSFS_utf8ToUtf16(const char *src, PHYSFS_uint16 *dst, PHYSFS_uint64 len);
   ...
   * \sa PHYSFS_eof
   */
  PHYSFS_DECL PHYSFS_sint64 PHYSFS_readBytes(PHYSFS_File *handle, void *buffer, PHYSFS_uint64 len);
   ...
   *          failure.
   */
  PHYSFS_DECL PHYSFS_sint64 PHYSFS_writeBytes(PHYSFS_File *handle, const void *buffer,
                                              PHYSFS_uint64 len);
  ...
  /**
   * \fn int PHYSFS_mountIo(PHYSFS_Io *io, const char *newDir, const char *mountPoint, int
   * appendToPath) \brief Add an archive, built on a PHYSFS_Io, to the search path.
   *
   ...
   * \sa PHYSFS_getMountPoint
   */
  PHYSFS_DECL int PHYSFS_mountIo(PHYSFS_Io *io, const char *newDir, const char *mountPoint,
                                 int appendToPath);

  /**
   * \fn int PHYSFS_mountMemory(const void *buf, PHYSFS_uint64 len, void (*del)(void *), const char
   * *newDir, const char *mountPoint, int appendToPath) \brief Add an archive, contained in a memory
   * buffer, to the search path.
   *
   * \warning Unless you have some special, low-level need, you should be using
   *          PHYSFS_mount() instead of this.
   *
  ...
  /**
   * \fn int PHYSFS_mountHandle(PHYSFS_File *file, const char *newDir, const char *mountPoint, int
   * appendToPath) \brief Add an archive, contained in a PHYSFS_File handle, to the search path.
   *
   * \warning Unless you have some special, low-level need, you should be using
   *          PHYSFS_mount() instead of this.
   *
   ...
   * \sa PHYSFS_getMountPoint
   */
  PHYSFS_DECL int PHYSFS_mountHandle(PHYSFS_File *file, const char *newDir, const char *mountPoint,
                                     int appendToPath);
