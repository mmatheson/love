...
static WUFF_INLINE void wuff_copy_chunk_header_data(struct wuff_chunk_header *chunk,
                                                    wuff_uint8 *data)
{
...
WUFF_INTERN_API wuff_sint32 wuff_search_chunk(struct wuff_handle *handle,
                                              struct wuff_chunk_header *chunk, wuff_uint64 *offset,
                                              wuff_uint32 id, wuff_uint32 stop_id);
...
WUFF_INTERN_API size_t wuff_calculate_samples(size_t target_size, wuff_uint8 sample_size,
...
WUFF_INTERN_API wuff_sint32 wuff_buffer_request(struct wuff_handle *handle, wuff_uint8 **buffer,
                                                size_t *samples);
