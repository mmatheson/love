...
WUFF_CONV_FUNC(wuff_int16_to_int16) { memcpy(dst, src + offset, samples * 2 + head + tail); }
...
WUFF_CONV_FUNC(wuff_int24_to_int24) { memcpy(dst, src + offset, samples * 3 + head + tail); }
...
WUFF_CONV_FUNC(wuff_int32_to_int32) { memcpy(dst, src + offset, samples * 4 + head + tail); }
...
WUFF_CONV_FUNC(wuff_float32_to_float32) { memcpy(dst, src + offset, samples * 4 + head + tail); }
...
WUFF_CONV_FUNC(wuff_float64_to_float64) { memcpy(dst, src + offset, samples * 8 + head + tail); }
