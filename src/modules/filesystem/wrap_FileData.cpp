...
FileData *luax_checkfiledata(lua_State *L, int idx) { return luax_checktype<FileData>(L, idx); }
...
static const luaL_Reg w_FileData_functions[] = {{"clone", w_FileData_clone},
...
{
  int ret =
      luax_register_type(L, &FileData::type, data::w_Data_functions, w_FileData_functions, nullptr);
