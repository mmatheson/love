...
void Filesystem::setAndroidSaveExternal(bool useExternal) { this->useExternal = useExternal; }

bool Filesystem::isAndroidSaveExternal() const { return useExternal; }
...
bool Filesystem::getConstant(const char *in, FileType &out) { return fileTypes.find(in, out); }

bool Filesystem::getConstant(FileType in, const char *&out) { return fileTypes.find(in, out); }

std::vector<std::string> Filesystem::getConstants(FileType) { return fileTypes.getNames(); }
