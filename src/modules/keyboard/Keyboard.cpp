...
bool Keyboard::getConstant(const char *in, Key &out) { return keys.find(in, out); }

bool Keyboard::getConstant(Key in, const char *&out) { return keys.find(in, out); }

bool Keyboard::getConstant(const char *in, Scancode &out) { return scancodes.find(in, out); }

bool Keyboard::getConstant(Scancode in, const char *&out) { return scancodes.find(in, out); }
...
StringMap<Keyboard::Key, Keyboard::KEY_MAX_ENUM> Keyboard::keys(Keyboard::keyEntries,
...
StringMap<Keyboard::Scancode, Keyboard::SCANCODE_MAX_ENUM> Keyboard::scancodes(
