...
{
  static const std::string supported[] = {"ay",   "gbs", "gym", "hes", "kss", "nsf",
...
love::sound::Decoder *GmeDecoder::clone() { return new GmeDecoder(data.get(), bufferSize); }
...
bool GmeDecoder::seek(double s) { return gme_seek(emu, static_cast<long>(s * 1000.0)) != 0; }
...
bool GmeDecoder::isSeekable() { return true; }

int GmeDecoder::getChannelCount() const { return 2; }

int GmeDecoder::getBitDepth() const { return 16; }

double GmeDecoder::getDuration() { return -1; }
