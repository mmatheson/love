...
DecoderImpl DecoderImplFor()
{
  ...
  decoderImpl.create = [](love::filesystem::FileData *data,
                          int bufferSize) -> love::sound::Decoder *
...
const char *Sound::getName() const { return "love.sound.lullaby"; }
...
#endif
      DecoderImplFor<WaveDecoder>(),      DecoderImplFor<FLACDecoder>(),
