...
const char *Image::getName() const { return "love.image.magpie"; }

love::image::ImageData *Image::newImageData(Data *data) { return new ImageData(data); }
...
love::image::ImageData *Image::newImageData(int width, int height, PixelFormat format, void *data,
                                            bool own)
{
...
const std::list<FormatHandler *> &Image::getFormatHandlers() const { return formatHandlers; }
