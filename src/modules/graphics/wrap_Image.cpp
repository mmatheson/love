...
Image *luax_checkimage(lua_State *L, int idx) { return luax_checktype<Image>(L, idx); }
...
static const luaL_Reg w_Image_functions[] = {{"isFormatLinear", w_Image_isFormatLinear},
