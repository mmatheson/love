...
ShaderStage::ShaderStage(Graphics *gfx, StageType stage, const std::string &glsl, bool gles,
      ...
      glslangShader(nullptr)
{
  ...
  if (!glslangShader->parse(&defaultTBuiltInResource, defaultversion, defaultprofile, forcedefault,
                            forwardcompat, EShMsgSuppressWarnings))
  {
...
bool ShaderStage::getConstant(const char *in, StageType &out) { return stageNames.find(in, out); }

bool ShaderStage::getConstant(StageType in, const char *&out) { return stageNames.find(in, out); }

StringMap<ShaderStage::StageType, ShaderStage::STAGE_MAX_ENUM>::Entry
    ShaderStage::stageNameEntries[] = {
        {"vertex", STAGE_VERTEX},
        {"pixel", STAGE_PIXEL},
};

StringMap<ShaderStage::StageType, ShaderStage::STAGE_MAX_ENUM> ShaderStage::stageNames(
    ShaderStage::stageNameEntries, sizeof(ShaderStage::stageNameEntries));
