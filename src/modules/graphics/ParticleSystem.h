...
class ParticleSystem : public Drawable
{
 public:
   ...
   * * Normal: Parameters denote the standard deviation in x and y direction. x and y are assumed to
   *be uncorrelated.
  ...
  /**
   * Sets the amount of variation to the sprite's beginning size (0 being no variation and 1.0 a
   *random size between start and end).
  ...
  /**
   * Sets the variation of the start spin (0 being no variation and 1 being a random spin between
   *start and end).
