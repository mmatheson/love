...
Texture *luax_checktexture(lua_State *L, int idx) { return luax_checktype<Texture>(L, idx); }
...
const luaL_Reg w_Texture_functions[] = {{"getTextureType", w_Texture_getTextureType},
