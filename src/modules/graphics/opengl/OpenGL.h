...
class OpenGL
{
 public:
   ...
   **/
  void setVertexAttributes(const vertex::Attributes &attributes,
  ...
  void framebufferTexture(GLenum attachment, TextureType texType, GLuint texture, int level,
   ...
   **/
  bool rawTexStorage(TextureType target, int levels, PixelFormat pixelformat, bool &isSRGB,
  ...
  static bool isPixelFormatSupported(PixelFormat pixelformat, bool rendertarget, bool readable,
                                     bool isSRGB);
