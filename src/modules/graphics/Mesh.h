...
class Mesh : public Drawable
{
 public:
  ...
  Mesh(Graphics *gfx, const std::vector<AttribFormat> &vertexformat, const void *data,
       size_t datasize, PrimitiveType drawmode, vertex::Usage usage);
  Mesh(Graphics *gfx, const std::vector<AttribFormat> &vertexformat, int vertexcount,
