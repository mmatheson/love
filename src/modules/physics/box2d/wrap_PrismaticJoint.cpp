...
{
  luax_markdeprecated(L, "PrismaticJoint:hasLimitsEnabled", API_METHOD, DEPRECATED_RENAMED,
...
{
  return luax_register_type(L, &PrismaticJoint::type, w_Joint_functions, w_PrismaticJoint_functions,
                            nullptr);
}
