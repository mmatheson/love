...
class Physics : public Module
{
 public:
   ...
   * @param collideConnected Whether the connected bodies should collide with each other. Defaults
   *to false.
   **/
   ...
   **/
  RevoluteJoint *newRevoluteJoint(Body *body1, Body *body2, float xA, float yA, float xB, float yB,
                                  bool collideConnected);
   ...
   * @param referenceAngle The reference angle.
   **/
  PrismaticJoint *newPrismaticJoint(Body *body1, Body *body2, float xA, float yA, float xB,
   ...
   *to true.
   **/
  PulleyJoint *newPulleyJoint(Body *body1, Body *body2, b2Vec2 groundAnchor1, b2Vec2 groundAnchor2,
                              b2Vec2 anchor1, b2Vec2 anchor2, float ratio, bool collideConnected);
   ...
   *to false.
   **/
  FrictionJoint *newFrictionJoint(Body *body1, Body *body2, float xA, float yA, float xB, float yB,
                                  bool collideConnected);
   ...
   * @param referenceAngle The reference angle.
   **/
  WeldJoint *newWeldJoint(Body *body1, Body *body2, float xA, float yA, float xB, float yB,
                          bool collideConnected);
   ...
   *to false.
   **/
  WheelJoint *newWheelJoint(Body *body1, Body *body2, float xA, float yA, float xB, float yB,
   ...
   *to false.
   **/
  RopeJoint *newRopeJoint(Body *body1, Body *body2, float x1, float y1, float x2, float y2,
