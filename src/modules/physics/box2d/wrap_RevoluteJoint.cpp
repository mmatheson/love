...
{
  luax_markdeprecated(L, "RevoluteJoint:hasLimitsEnabled", API_METHOD, DEPRECATED_RENAMED,
...
{
  return luax_register_type(L, &RevoluteJoint::type, w_Joint_functions, w_RevoluteJoint_functions,
                            nullptr);
}
