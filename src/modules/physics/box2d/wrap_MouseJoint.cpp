...
static const luaL_Reg w_MouseJoint_functions[] = {{"setTarget", w_MouseJoint_setTarget},
...
{
  return luax_register_type(L, &MouseJoint::type, w_Joint_functions, w_MouseJoint_functions,
                            nullptr);
}
