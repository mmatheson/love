...
class PrismaticJoint : public Joint
{
 public:
   ...
   **/
  PrismaticJoint(Body *body1, Body *body2, float xA, float yA, float xB, float yB, float ax,
 ...
 private:
  ...
  void init(b2PrismaticJointDef &def, Body *body1, Body *body2, float xA, float yA, float xB,
