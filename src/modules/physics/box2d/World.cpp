...
float32 World::RayCastCallback::ReportFixture(b2Fixture *fixture, const b2Vec2 &point,
...
void World::BeginContact(b2Contact *contact) { begin.process(contact); }
...
bool World::isValid() const { return world != nullptr; }
...
void World::setGravity(float x, float y) { world->SetGravity(Physics::scaleDown(b2Vec2(x, y))); }
...
void World::setSleepingAllowed(bool allow) { world->SetAllowSleeping(allow); }

bool World::isSleepingAllowed() const { return world->GetAllowSleeping(); }

bool World::isLocked() const { return world->IsLocked(); }
...
int World::getJointCount() const { return world->GetJointCount(); }

int World::getContactCount() const { return world->GetContactCount(); }
...
b2Body *World::getGroundBody() const { return groundBody; }
...
void World::unregisterObject(void *b2object) { box2dObjectMap.erase(b2object); }
