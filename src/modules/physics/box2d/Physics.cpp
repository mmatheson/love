...
Physics::Physics() { meter = DEFAULT_METER; }

Physics::~Physics() {}

const char *Physics::getName() const { return "love.physics.box2d"; }
...
CircleShape *Physics::newCircleShape(float radius) { return newCircleShape(0, 0, radius); }
...
PolygonShape *Physics::newRectangleShape(float x, float y, float w, float h, float angle)
{
  ...
  s->SetAsBox(Physics::scaleDown(w / 2.0f), Physics::scaleDown(h / 2.0f),
              Physics::scaleDown(b2Vec2(x, y)), angle);
...
DistanceJoint *Physics::newDistanceJoint(Body *body1, Body *body2, float x1, float y1, float x2,
                                         float y2, bool collideConnected)
{
...
RevoluteJoint *Physics::newRevoluteJoint(Body *body1, Body *body2, float xA, float yA, float xB,
...
RevoluteJoint *Physics::newRevoluteJoint(Body *body1, Body *body2, float xA, float yA, float xB,
                                         float yB, bool collideConnected, float referenceAngle)
{
  return new RevoluteJoint(body1, body2, xA, yA, xB, yB, collideConnected, referenceAngle);
}

PrismaticJoint *Physics::newPrismaticJoint(Body *body1, Body *body2, float xA, float yA, float xB,
                                           float yB, float ax, float ay, bool collideConnected)
{
...
PulleyJoint *Physics::newPulleyJoint(Body *body1, Body *body2, b2Vec2 groundAnchor1,
                                     b2Vec2 groundAnchor2, b2Vec2 anchor1, b2Vec2 anchor2,
...
FrictionJoint *Physics::newFrictionJoint(Body *body1, Body *body2, float xA, float yA, float xB,
                                         float yB, bool collideConnected)
{
  return new FrictionJoint(body1, body2, xA, yA, xB, yB, collideConnected);
}

WeldJoint *Physics::newWeldJoint(Body *body1, Body *body2, float xA, float yA, float xB, float yB,
...
WheelJoint *Physics::newWheelJoint(Body *body1, Body *body2, float xA, float yA, float xB, float yB,
                                   float ax, float ay, bool collideConnected)
{
  return new WheelJoint(body1, body2, xA, yA, xB, yB, ax, ay, collideConnected);
}

RopeJoint *Physics::newRopeJoint(Body *body1, Body *body2, float x1, float y1, float x2, float y2,
...
{
  if (scale < 1)
    throw love::Exception("Physics error: invalid meter");
  Physics::meter = scale;
}

float Physics::getMeter() { return meter; }
...
float Physics::scaleDown(float f) { return f / meter; }

float Physics::scaleUp(float f) { return f * meter; }
