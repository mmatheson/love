...
GlyphData *luax_checkglyphdata(lua_State *L, int idx) { return luax_checktype<GlyphData>(L, idx); }
...
const luaL_Reg w_GlyphData_functions[] = {{"clone", w_GlyphData_clone},
...
{
  int ret = luax_register_type(L, &GlyphData::type, data::w_Data_functions, w_GlyphData_functions,
                               nullptr);
