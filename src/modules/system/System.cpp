...
bool System::openURL(const std::string &url) const
{
  ...
  bool success = false;
  CFURLRef cfurl = CFURLCreateWithBytes(nullptr, (const UInt8 *) url.c_str(), url.length(),
  ...
  result = ShellExecuteW(nullptr, L"open", wurl.c_str(), nullptr, nullptr, SW_SHOW);
...
StringMap<System::PowerState, System::POWER_MAX_ENUM>::Entry System::powerEntries[] = {
    {"unknown", System::POWER_UNKNOWN},      {"battery", System::POWER_BATTERY},
    {"nobattery", System::POWER_NO_BATTERY}, {"charging", System::POWER_CHARGING},
