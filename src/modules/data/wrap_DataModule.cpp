...
static const luaL_Reg functions[] = {{"newDataView", w_newDataView},
...
static const lua_CFunction types[] = {luaopen_data, luaopen_bytedata, luaopen_dataview,
                                      luaopen_compresseddata, nullptr};
