...
DataView *luax_checkdataview(lua_State *L, int idx) { return luax_checktype<DataView>(L, idx); }
...
static const luaL_Reg w_DataView_functions[] = {{"clone", w_DataView_clone}, {0, 0}};
