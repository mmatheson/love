...
inline bool point_in_triangle(const Vector2 &p, const Vector2 &a, const Vector2 &b,
                              const Vector2 &c)
{
...
bool any_point_in_triangle(const std::list<const Vector2 *> &vertices, const Vector2 &a,
...
inline bool is_ear(const Vector2 &a, const Vector2 &b, const Vector2 &c,
...
RandomGenerator *Math::newRandomGenerator() { return new RandomGenerator(); }
...
Transform *Math::newTransform() { return new Transform(); }
