...
inline Vector2 Vector2::getNormal(float scale) const { return Vector2(-y * scale, x * scale); }

inline float Vector2::dot(const Vector2 &a, const Vector2 &b) { return a.x * b.x + a.y * b.y; }

inline float Vector2::cross(const Vector2 &a, const Vector2 &b) { return a.x * b.y - a.y * b.x; }
...
inline Vector2 Vector2::operator*(float s) const { return Vector2(x * s, y * s); }
...
inline float Vector3::getLengthSquare() const { return x * x + y * y + z * z; }
...
inline float Vector4::getLengthSquare() const { return x * x + y * y + z * z + w * w; }
...
inline Vector4 Vector4::operator*(float s) const { return Vector4(x * s, y * s, z * s, w * s); }
