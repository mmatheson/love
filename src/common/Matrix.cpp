...
void Matrix4::multiply(const Matrix4 &a, const Matrix4 &b, Matrix4 &t) { multiply(a, b, t.e); }
...
Matrix4::Matrix4(const float elements[16]) { memcpy(e, elements, sizeof(float) * 16); }
...
Matrix4::Matrix4(const Matrix4 &a, const Matrix4 &b) { multiply(a, b, e); }
...
Matrix4 Matrix4::operator*(const Matrix4 &m) const { return Matrix4(*this, m); }
...
const float *Matrix4::getElements() const { return e; }
...
Matrix4 Matrix4::inverse() const
{
  ...
  for (int i = 0; i < 16; i++) inv.e[i] *= invdet;
...
const float *Matrix3::getElements() const { return e; }
